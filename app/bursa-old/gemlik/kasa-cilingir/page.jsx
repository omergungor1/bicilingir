...
export default function GemlikKasaCilingirPage() {
    const sssList = [
        {
            question: `Gemlik'te kasa çilingiri ne kadar?`,
            answer: `Gemlik'te kasa çilingiri hizmet fiyatları 500₺-1500₺ arasında değişmektedir. Kasanın tipi, markası ve durumuna göre fiyat değişebilir. Net fiyat için arayabilirsiniz.`
        },
        {
    ...
    return (
        <div className="min-h-screen bg-gray-50 overflow-x-hidden touch-pan-y px-4 md:px-16 lg:px-32 pt-2 pb-8">
            {/* Sayfa başlığı */}
            <div className="mb-3">
                <h1 className="text-xl font-bold mb-2">Gemlik Kasa Çilingiri</h1>
                ...
                <p className="text-sm md:text-base text-gray-700">
                    Gemlik'te kasa açma, şifre değişimi ve tamir konusunda uzman çilingirler. Tüm marka kasalar için hizmet veriliyor. Bilgi için hemen arayın!
                </p>
            </div>
            ...
            <section aria-label="Kasa Çilingiri Bilgilendirme">
                <h2 className="text-xl font-bold mb-4">Gemlik Kasa Çilingiri Hizmetleri</h2>
...
export async function generateMetadata() {
    return {
        title: 'Gemlik Kasa Çilingiri - Kasa Açma ve Şifre Değişimi | Profesyonel Hizmet',
        description: 'Gemlik\'te kasa çilingiri hizmeti ✓ Kasa açma 500₺\'den başlayan fiyatlarla ✓ Şifre değişimi ✓ Kasa tamiri. Hemen Ara!',
        keywords: 'Gemlik kasa çilingiri, kasa açma, şifre değişimi, kasa tamiri, kasa bakımı',
        openGraph: {
            title: 'Gemlik Kasa Çilingiri | Güvenilir ve Profesyonel',
            description: '✓ Kasa Açma\n✓ Şifre Değişimi\n✓ Kasa Tamiri\n✓ Uzman Ekip',
            type: 'website',
            locale: 'tr_TR',
            url: 'https://bicilingir.com/bursa/gemlik/kasa-cilingir',
            siteName: 'Bi Çilingir',
            images: [{
                url: 'https://bicilingir.com/images/gemlik-kasa-cilingir.png',
                width: 1200,
                height: 630,
                alt: 'Gemlik Kasa Çilingiri Hizmeti'
            }]
        },
        twitter: {
            ...
            title: 'Gemlik Kasa Çilingiri | Güvenilir ve Profesyonel',
            description: '✓ Kasa Açma\n✓ Şifre Değişimi\n✓ Kasa Tamiri',
            images: ['https://bicilingir.com/images/gemlik-kasa-cilingir.png']
        },
        alternates: {
            canonical: 'https://bicilingir.com/bursa/gemlik/kasa-cilingir'
        },
        robots: {
            index: true,
            follow: true,
