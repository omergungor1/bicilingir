...
export default function YildirimCilingirPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 overflow-x-hidden touch-pan-y px-4 md:px-16 lg:px-32 py-2">
            ...
            {/* Çilingir Hizmetleri */}
            <h2 className="text-xl font-bold mb-4">Yıldırım Çilingir Hizmetleri</h2>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Yıldırım'ın tüm mahallelerinde 7/24 kesintisiz çilingir hizmeti. Gece gündüz demeden dakikalar içinde yanınızdayız. Hemen arayın!</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Yıldırım'da kapıda mı kaldınız? Endişelenmeyin! En yakın çilingir ekibimiz size bir telefon kadar yakın. Uygun fiyat garantisiyle hemen gelelim.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Yıldırım'da araç anahtarı mı kayboldu? Tüm marka araçlar için yerinde anahtar kopyalama, immobilizer ve kumanda kodlama. Şimdi ulaşın!</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Yıldırım'da ev, apartman ve iş yeri kapıları için uzman çilingir. Çelik kapı, elektronik kilit ve alarm sistemleri için hemen bizi arayın!</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Yıldırım'da kasa açma konusunda uzman ekip. Para kasası, çelik kasa ve dijital kasa sorunlarınız için güvenilir çözüm ortağınız. Bizi arayın!</p>
                        </div>
                    </div>
                </div>
            </div>
