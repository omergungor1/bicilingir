    ...
    <main className="flex min-h-screen flex-col items-center">
        ...
        <div className="container mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between">
          ...
          <nav className="flex mb-4 md:mb-0">
            <ul className="flex space-x-6">
              <li><a href="#" className="text-white hover:text-blue-200 transition-colors">Ana Sayfa</a></li>
              <li><a href="#" className="text-white hover:text-blue-200 transition-colors">Hizmetler</a></li>
              <li><a href="#" className="text-white hover:text-blue-200 transition-colors">Çilingirler</a></li>
              <li><a href="#" className="text-white hover:text-blue-200 transition-colors">Hakkımızda</a></li>
            </ul>
          </nav>
      ...
      <section style={styles.heroSection} className="w-full py-16 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Kapınız Kilitli mi Kaldı?</h1>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Türkiye'nin her yerinde profesyonel çilingir hizmetine anında ulaşın. 
            7/24 hizmet, uygun fiyatlar ve güvenilir çözümler.
          </p>
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="flex gap-2 justify-center items-center shadow-lg">
              <div className="relative flex-grow">
                ...
                <Input 
                  type="text" 
                  placeholder="Adresinizi giriniz (Mahalle, İlçe, İl)" 
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            <nav>
              <ul className="flex flex-wrap justify-center gap-6">
                <li><a href="#" className="hover:text-blue-300 transition-colors">Ana Sayfa</a></li>
                <li><a href="#" className="hover:text-blue-300 transition-colors">Hizmetler</a></li>
                <li><a href="#" className="hover:text-blue-300 transition-colors">Çilingirler</a></li>
                <li><a href="#" className="hover:text-blue-300 transition-colors">İletişim</a></li>
              </ul>
            </nav>
            
            <div className="flex gap-4 mt-4 md:mt-0">
              <a href="#" className="hover:text-blue-300 transition-colors">Kullanım Şartları</a>
              <a href="#" className="hover:text-blue-300 transition-colors">Gizlilik Politikası</a>
            </div>
          </div>
