        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-2/3 p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-gray-200">
              ...
              {
                locksmith.locksmith_certificates && locksmith.locksmith_certificates.length > 0 && (
                  <div className="border-t border-gray-200 pt-6 mb-6">
                    <h2 className="text-xl font-bold text-gray-800 mb-4">Sertifikalar ve Belgeler</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {locksmith.locksmith_certificates.map((certificate, index) => (
                        <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:shadow-md transition-shadow">
                          <div className="flex items-center">
                            {/* Dosya tipine göre farklı ikonlar */}
                            <div className="mr-3 flex-shrink-0">
                              {certificate.filetype && certificate.filetype.startsWith('application/pdf') ? (
                                <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center text-red-500">
                                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                  </svg>
                                </div>
                              ) : certificate.filetype && certificate.filetype.startsWith('image/') ? (
                            ...
                            <div className="flex-grow">
                              <div className="font-medium text-gray-800">{certificate.name}</div>
                            </div>
                            ...
                            {certificate.fileurl && (
                              <a
                                ...
                                className="ml-2 bg-blue-600 hover:bg-blue-700 text-white py-1 px-3 rounded-lg text-sm flex items-center transition-colors"
                              >
