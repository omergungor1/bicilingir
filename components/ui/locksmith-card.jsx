                        ...
                        <div>
                            <div className="flex flex-col gap-1">
                                <div className="flex flex-row items-center gap-2">
                                    <h3 className={`text-xl font-bold text-blue-800`}>{locksmith.name}</h3>
                ...
                <div className="px-4 pb-2 flex flex-col justify-center md:w-64">
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2 md:flex-col">
                            <Button
                                variant="outline"
                                className="flex-1 text-white flex items-center justify-center gap-1 bg-green-600 hover:bg-green-700 font-bold shadow-md opacity-85"
